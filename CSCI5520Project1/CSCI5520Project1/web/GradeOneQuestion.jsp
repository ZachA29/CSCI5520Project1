...
<html>
    <head>
        ...
        <script type="text/javascript">$(document).ready(function () {
                $("#a1").click(function () {
                    $(this).text("TEST");
                    $(this).append("<div style = 'color: purple; font-family: Times New Roman;'>" + ${questions.getHint()} + "</div>");
                });
            });</script> 
        <script type="text/javascript">$(document).ready(function () {
                $("#a2").click(function () {
                    $(this).text("TEST"); $(this).append("<div style = 'color: purple; font-family: Times New Roman;'>" + ${questions.getHint()} + "</div>");
                });
            });</script>
    </head>
    <body>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <c:if test="${questions.getHint() != null}">
                                                The correct answer for this question is: <% questions.getAnswerKey(); %><jsp:getProperty name="questions" property="answerKey" /><br/>
